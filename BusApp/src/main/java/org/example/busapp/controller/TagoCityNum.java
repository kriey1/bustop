...
public class TagoCityNum {
    ...
    public String getCityCodeList() throws IOException {
        StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/1613000/ArvlInfoInqireService/getCtyCodeList");
